...
def merge_jsonl_files(input_folder: str, output_file: str = None, suffix: str=".medium"):
    """
    ...
    jsonl_files = list(input_path.glob(f"*{suffix}"))
    ...
    output_file = Path(output_file+suffix)
...
def main():
    ...
    # Execute merge
    success_medium = merge_jsonl_files(args.input_folder, args.output_file, suffix=".base")
    success_medium = merge_jsonl_files(args.input_folder, args.output_file, suffix=".medium")
    success_high = merge_jsonl_files(args.input_folder, args.output_file, suffix=".high")
    
    
    if not success_medium or not success_high:
        exit(1)
